OC.L10N.register(
    ...
    "No license key available." : "Kein Lizenzschlüssel verfügbar.",
    "Invalid license key!" : "Ungültiger Lizenzschlüssel!",
    "Please contact your administrator or %s for a new license key." : "Bitte wenden Sie sich an Ihren Administrator oder %s für einen neuen Lizenzschlüssel.",
    "Your Enterprise license key has expired." : "Ihr Enterprise-Lizenzschlüssel ist abgelaufen.",
    "Enterprise features have been disabled." : "Enterprise-Funktionen wurden deaktiviert.",
    "Evaluation - expires in %d days." : "Evaluierung - läuft in %d Tagen ab.",
    "Your Enterprise license key is about to expire (days remaining: %d)." : "Ihr Enterprise-Lizenzschlüssel läuft demnächst ab (verbleibende Tage: %d).",
    "The registered enterprise license key expires in %d days" : "Der registrierte Enterprise-Lizenzschlüssel läuft in %d Tagen ab",
    ...
    "%s enter the database name or connection string." : "%s gib den Datenbanknamen oder den Verbindungsnamen an.",
    ...
    "Can't create or write into the apps-external directory %s" : "Das \"apps-extern\"-Verzeichnis %s kann nicht erstellt oder es kann darin nicht geschrieben werden.",
    "Can't update %s - it is a directory" : "%s ist ein Ordner und kann deshalb nicht aktualisiert werden.",
    "Can't update %s" : "%s kann nicht aktualisiert werden",
    "Invalid Federated Cloud ID" : "Ungültige Federated-Cloud-ID",
    "Internal mail notification for shared files is not allowed" : "E-Mail Benachrichtigungen für geteilte Dateien sind nicht erlaubt.",
    "%s shared »%s« with you" : "%s hat „%s“ mit Dir geteilt",
    "Public link mail notification is not allowed" : "E-Mail Benachrichtigungen für öffentliche Links sind nicht erlaubt.",
    "%s via %s" : "%s via %s",
    "Sharing %s failed, because the backend does not allow shares from type %d" : "Freigabe von %s fehlgeschlagen, da das Backend die Freigabe vom Typ %d nicht erlaubt.",
    ...
    "Cannot set the requested share permissions for %s" : "Die gewünschten Berechtigungen für %s können nicht gesetzt werden.",
    "Cannot set the requested share attributes for %s" : "Die gewünschten Eigenschaften für %s können nicht gesetzt werden.",
    ...
    "Only the following characters are allowed in a username: \"a-z\", \"A-Z\", \"0-9\", and \"+_.@-'\"" : "Ein Benutzername darf nur nur die folgenden Zeichen enthalten: \"a-z\", \"A-Z\", \"0-9\", und \"+_.@-'\"",
    ...
    "\"%s\" is locked" : "\"%s\" wird im Hintergrund bearbeitet und wird angezeigt, sobald der Vorgang abgeschlossen ist."
},
